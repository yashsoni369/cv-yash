...
import { infinityDevopsContent } from './infinity-devops-i18n'

const ICON_MAP: Record<string, typeof Bot> = { Bot, Database, Search, Shield, FileText }

export default function InfinityDevOps({ lang }: { lang: 'es' | 'en' }) {
  const t = infinityDevopsContent[lang] || infinityDevopsContent.en
