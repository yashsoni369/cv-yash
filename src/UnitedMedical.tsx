...
import { unitedMedicalContent } from './united-medical-i18n'

const ICON_MAP: Record<string, typeof Bot> = { Bot, Database, Search, Shield, FileText }

export default function UnitedMedical({ lang }: { lang: 'es' | 'en' }) {
  const t = unitedMedicalContent[lang] || unitedMedicalContent.en
